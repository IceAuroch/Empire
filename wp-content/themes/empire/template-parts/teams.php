                        ...
                        <?php while ($team->have_posts()) : $team->the_post(); ?>
                            ...
                            <div class="teams-col">
                                <div class="teams-item"
                                     ...
                                     data-name="<?= the_title($post->id); ?>"
                                     data-position="<?= get_field('position', $post->ID, 'text_field'); ?>"
                                     data-description="<?= get_the_content($post->id) ?>">
                                    <div class="img" style="background-image:
                                            url(<?= get_the_post_thumbnail_url($post->id, 'large'); ?>)">
                                    </div>
                                    <div class="name"><?= get_the_title($post->id); ?></div>
                                </div>
                            </div>
