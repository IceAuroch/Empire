...
(function () {
    ...
    $('.buy-car-open').on('click', function (e) {
        e.preventDefault();
        $('.custom-modal--buy-car').addClass('active');
        $('.modal-mask').addClass('active');
    });
    $('.test-drive-open').on('click', function (e) {
        e.preventDefault();
        $('.custom-modal--test-drive').addClass('active');
        $('.modal-mask').addClass('active');
    });
    ...
    let elem5 = document.querySelector('.car-single-slider');
    let galleryNavFor = document.querySelector('.car-single-slider-navfor');

    if (elem5 && galleryNavFor) {
        let flkty1 = new Flickity(elem5, {
            prevNextButtons: false,
            cellAlign: 'left',
            contain: true,
            draggable: false,
        ...
        let prevArrowObject = document.querySelector('.slider-arrow-item--prev-car-single');

        prevArrowObject.addEventListener('click', function () {
            flkty1.previous(false, false);
        });

        let nextArrowObject = document.querySelector('.slider-arrow-item--next-car-single');
